// Application Data with Qikink Integration
const products = [
    {
        id: 1,
        ...
        price: 599,
        originalPrice: 799,
        image: "images/classic-cotton-tee.png",
        category: "Basic",
        sizes: ["XS", "S", "M", "L", "XL", "XXL"],
        colors: ["White", "Black", "Navy", "Gray"],
        description: "Premium quality 100% cotton t-shirt with custom print. Perfect for daily wear.",
        rating: 4.5,
        reviews: 24,
        qikinkSku: "MVnHs-Wh-S", // Qikink product SKU
        qikinkPrintType: 1 // DTG printing
    },
    {
        id: 2,
        ...
        description: "Eye-catching graphic design on premium fabric. Stand out with unique artwork.",
        rating: 4.7,
        reviews: 18,
        qikinkSku: "MVnHs-Bk-M",
        qikinkPrintType: 1
    },
    {
        id: 3,
        ...
        description: "Clean, minimalist design perfect for any occasion. Subtle branding.",
        rating: 4.3,
        reviews: 31,
        qikinkSku: "MVnHs-Gy-L",
        qikinkPrintType: 1
    },
    {
        id: 4,
        ...
        category: "Vintage",
        sizes: ["S", "M", "L", "XL", "XXL"],
        colors: ["Vintage White", "Charcoal", "Rust"],
        description: "Retro-inspired design with distressed print effect. Premium vintage feel.",
        rating: 4.6,
        reviews: 15,
        qikinkSku: "MVnHs-Vw-XL",
        qikinkPrintType: 1
    },
    {
        id: 5,
        ...
        description: "Moisture-wicking fabric perfect for workouts. Athletic fit and comfort.",
        rating: 4.4,
        reviews: 22,
        qikinkSku: "MVnHs-Nv-L",
        qikinkPrintType: 1
    },
    {
        id: 6,
        ...
        sizes: ["XS", "S", "M", "L", "XL"],
        colors: ["White", "Black"],
        description: "Beautiful artistic design created by independent artists. Limited edition.",
        rating: 4.8,
        reviews: 12,
        qikinkSku: "MVnHs-Wh-M",
        qikinkPrintType: 1
    }
];
...
function addToCartFromModal() {
    ...
    const cartItem = {
        ...
        qikinkSku: currentProduct.qikinkSku,
...
// NEW: Qikink Integration - Handle checkout with real API
async function handleQikinkCheckout(e) {
    ...
    try {
        ...
        // Prepare order data for Qikink API
        const orderData = {
            ...
            line_items: cart.map(item => ({
                ...
                print_type_id: item.qikinkPrintType,
                price: item.price.toString(),
                sku: item.qikinkSku,
                designs: [{
                    design_code: `design_${item.productId}_${Date.now()}`,
                    width_inches: "10",
                    height_inches: "10", 
                    placement_sku: "fr", // Front placement
                    design_link: item.image.includes('placeholder') ? 
                        "https://via.placeholder.com/300x300/cccccc/666666?text=Design" : 
                        item.image,
                    mockup_link: item.image.includes('placeholder') ? 
                        "https://via.placeholder.com/300x300/cccccc/666666?text=Mockup" : 
                        item.image
                }]
            })),
            shipping_address: {
